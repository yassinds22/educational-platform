    ...
    <div class="min-h-[calc(100vh-200px)] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div class="sm:mx-auto sm:w-full sm:max-w-md text-right">
            ...
            <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                هل لديك حساب بالفعل؟
                <a href="/login" class="font-medium text-[#2A4B7C] dark:text-blue-400 hover:text-[#1e3458] dark:hover:text-blue-300 transition-colors">
                    سجل دخولك من هنا
                </a>
            </p>
        </div>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow-xl border border-gray-100 dark:border-gray-700 sm:rounded-2xl sm:px-10 transition-all">
                <form class="space-y-5 text-right" action="#" method="POST">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            الاسم الكامل
                        </label>
                        <div class="mt-1">
                            <x-input id="name" name="name" type="text" autocomplete="name" required placeholder="الاسم الكامل" class="text-right" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <x-input id="password" name="password" type="password" autocomplete="new-password" required placeholder="••••••••" class="text-right" />
                        </div>
                        <p class="mt-1 text-xs text-gray-500">يجب أن يتكون من 8 أحرف على الأقل.</p>
                    </div>

                    <div class="flex items-center flex-row-reverse justify-end">
                        <input id="terms" name="terms" type="checkbox" required class="h-4 w-4 text-[#2A4B7C] focus:ring-[#2A4B7C] border-gray-300 rounded cursor-pointer transition-colors">
                        <label for="terms" class="mr-2 block text-sm text-gray-900 dark:text-gray-300 cursor-pointer">
                            أوافق على <a href="#" class="text-[#2A4B7C] dark:text-blue-400 hover:underline">شروط الخدمة</a> و <a href="#" class="text-[#2A4B7C] dark:text-blue-400 hover:underline">سياسة الخصوصية</a>
                        </label>
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        <x-button variant="outline" class="w-full inline-flex justify-center border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            <span class="sr-only">تسجيل باستخدام فيسبوك</span>

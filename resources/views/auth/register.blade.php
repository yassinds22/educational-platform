            ...
            <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow-xl border border-gray-100 dark:border-gray-700 sm:rounded-2xl sm:px-10 transition-all">
                <form class="space-y-5" action="#" method="POST">
                    <div>
                        ...
                        <div class="mt-1">
                            <x-input id="name" name="name" type="text" autocomplete="name" required placeholder="John Doe" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <x-input id="email" name="email" type="email" autocomplete="email" required placeholder="you@example.com" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <x-input id="password" name="password" type="password" autocomplete="new-password" required placeholder="••••••••" />
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-900 dark:text-gray-300 cursor-pointer">
                            I agree to the <a href="#" class="text-[#2A4B7C] dark:text-blue-400 hover:underline">Terms of Service</a> and <a href="#" class="text-[#2A4B7C] dark:text-blue-400 hover:underline">Privacy Policy</a>
                        </label>
                    </div>
